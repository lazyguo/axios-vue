  ...
  <div class="home">
      <div class="login-box">
        ...
        <el-row style="margin-top:30px">
          <el-form ref="form" :model="form" label-width="70px" style="width:400px;margin:0 auto" label-position="right">
            <el-form-item label="用户名:" prop="username">
              <el-input  placeholder="请输入用户名" size="medium" v-model="form.username"></el-input>
            </el-form-item>
            <el-form-item label="密码:" prop="password">
              <el-input show-password placeholder="请输入密码" size="medium" v-model="form.password"></el-input>
            </el-form-item>
          </el-form>
        </el-row>
...
<style scoped>
  .home {
    width: 100%;
    height: 100%;
    background: url('../assets/img/壁纸3.jpg') no-repeat fixed center;
  }
  .login-box {
    position: absolute;
    top: 50%;
  ...
  .container{
    ...
    width: 240px;
    height: 37px;
    background-color: rgba(67, 93, 118,.5);
    margin: 0 auto;
    border-radius: 5px;
